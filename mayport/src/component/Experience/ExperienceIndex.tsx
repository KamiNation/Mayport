...
const ExperienceIndex = () => {
    return (
        <div className="flex mt-4 sm:flex md:flex sm:flex-col md:flex-col ">
            <ExperienceLeft />
            <div className="flex flex-col justify-center items-center ml-4 text-20v1 sm:text-[15px] md:text-[18px]">
