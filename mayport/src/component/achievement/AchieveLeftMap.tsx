...
const AchieveLeftMap = () => {
    return (
        <div className="flex bg-customBlue py-24 px-36 sm:p-0 md:p-0 justify-between items-center gap-x-10 sm:flex  md:flex sm:flex-wrap md:flex-wrap sm:gap-y-5 md:gap-y-5 sm:flex-col md:flex-col">
            {
