...
const AchieveCard: React.FC<top1rightmap> = ({ image, p1, p2 }) => {
    return (
        <div className="flex flex-col items-center gap-y-6 sm:flex sm:mt-2 md:flex md:mt-2 lg:flex lg:mt-2">
            <ImgComponent
            imgClass="w-12 h-12 "
                image={image}
            />
            <div className="flex sm:flex md:flex  sm:justify-center lg:ju md:justify-center items-center">
