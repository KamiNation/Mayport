...
const TopFooterIndex: React.FC<top1rightmap> = ({ image, p1, p2 }) => {
    return (
        <>
            <div className="flex sm:flex sm:items-center sm:justify-center  lg:flex lg:items-center lg:justify-center md:flex md:items-center md:justify-center xl:flex-1 md:flex-1 sm:flex-1">
                <div>
                    <ImgComponent
                        image={image}
                        alt="earth-logo"
