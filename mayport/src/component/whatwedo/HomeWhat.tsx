...
const HomeWhat = () => {
    return (
        <div className="mt-8">
            <div className="flex flex-col flex-1 gap-y-8 mb-4 ">
                <p className="flex flex-1 text-28 sm:text-[24px] md:text-[26px] sm:items-center lg:items-center md:items-center sm:justify-center md:justify-center lg:justify-center xl:items-center xl:justify-center">
                    What We Do
                </p>
                <p className="flex flex-1 text-20v1 text-customGray sm:text-[15px] md:text-[18px] lg:text-[22px]">
