    ...
    return (
        <div className="mt-8">
            <div className="flex flex-col gap-y-8 mb-4 ">
                <p className="flex text-28 sm:text-[24px] md:text-[26px] sm:items-center md:items-center sm:justify-center md:justify-center">
                    What We Do
                </p>
                <p className="flex text-20v1 text-customGray sm:text-[15px] md:text-[18px]">
