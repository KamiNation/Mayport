...
const WhatCard: React.FC<top1rightmap> = ({ p1, p2, image, p3 }) => {
    return (
        <div className=" flex flex-col">
            ...
            <div className="flex flex-col p-6 gap-y-8  flex-1 w-408 sm:w-[200px] md:w-[416px]">
                <div className="flex flex-col gap-y-4 mb-8 flex-1 sm:flex md:flex">
                    <p className="flex text-28 sm:text-[20px] md:text-[22px] md:flex sm:flex">{p1}</p>
                    <p className=" w-360 sm:w-[200px] md:text-center sm:text-center text-20v1 text-customGray sm:text-[18px] md:text-[20px]">  {p2}</p>
                </div>
